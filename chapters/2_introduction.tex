...
\newline
\todo[inline]{is this your approach? the current general approach?}
...
Mutation testing has considerable drawbacks\todo{add ref}, such as the equivalent mutant problem and being resource expensive.
...
Our goal is to cluster any mutant that is generated \todo{make the goal clearer: no requirements on which mutants get clustered: aim at generic mutant clustering}.
...
\begin{enumerate}
 \item A methodology to cluster generated mutants based on chosen characteristics to reduce the cost of mutation testing.\todo{both white box and black box?}
