...
We identified characteristics to represent mutants in Chapter \ref{identifying_characteristics}.
With the mutants represented it is possible to cluster them.
The following sections describe the methodology for our white box approach of clustering mutants.
