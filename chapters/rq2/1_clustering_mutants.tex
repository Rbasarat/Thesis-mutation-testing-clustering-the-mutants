...
For the same reasons as in Chapter \ref{ch:fcm_implementation} we select a library that implements the subtractive clsutering algorithm.
...
Matlab is a tool specifically designed for academic world and is professionally maintained for this reason we decided to use their implementation of subtractive clustering.
