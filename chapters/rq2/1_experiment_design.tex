...
In this chapter we design an experiment to validate our black box approach.
...
We select a machine learning model, decide on a training strategy, train the model and validate the results.
